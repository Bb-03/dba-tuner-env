...
class DbaTunerEnv(
    ...
    Example:
        ...
        ...
        ...     result = client.step(DbaTunerAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = DbaTunerEnv.from_docker_image("dba_tuner_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(DbaTunerAction(message="Test"))
        ... finally:
        ...     client.close()
    """

    def _step_payload(self, action: DbaTunerAction) -> Dict:
        """
        Convert DbaTunerAction to JSON payload for step message.

        Args:
            action: DbaTunerAction instance
    ...
    def _parse_result(self, payload: Dict) -> StepResult[DbaTunerObservation]:
        """
        ...
        Returns:
            StepResult with DbaTunerObservation
        """
